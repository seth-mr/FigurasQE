...
public class DetailModel : PageModel
{
    ...
    public DetailModel(HttpClient http, IConfiguration configuration)
    {
        client = http;
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        {
            ErrorMessage = "Se cargaron tus datos, pero no se pudo cargar tu historial de sesiones.";
        }
    ...
    {
        var totalMinutes = FilteredSessions.Sum(session =>
    ...
    {
        return FilteredSessions.Sum(session => session.LevelResults.Count(result => result.Completed == true));
    }

    public int PlayedLevelsCount()
    {
        return FilteredSessions.Sum(session => session.LevelResults.Count);
    }
